...
class GameSerializerTestCase(TestCase):
      ...
      def test_serializer_blank_fields(self):
        ...
        self.assertEqual(serializer.errors.get("home_team")["group"][0], '"" is not a valid choice.')
        ...
        self.assertEqual(serializer.errors.get("away_team")["group"][0], '"" is not a valid choice.')
